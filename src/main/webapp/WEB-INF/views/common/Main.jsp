...
<div class="jumbotron col-xs-12" style=" background-image: url('./resources/images/main/ddabang2.jpg');">
		...
		<div class="col-xs-12 col-md-12" style="text-align: center; margin-top: 50px; margin-bottom: 50px;">
			...
			<a href="<c:url value='/Member/SalesTerms.bbs'/>"><button type="button" class="btn btn-default">매물 관리 규정</button></a>
			<a href="<c:url value='/Member/AutosaveTerms.bbs'/>"><button type="button" class="btn btn-default">자동저장 서비스</button></a>
		</div>
</div>

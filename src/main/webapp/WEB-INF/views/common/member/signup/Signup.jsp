...
<div class="container">
	...
	<form action="<c:url value='/Member/SignupInsert.bbs'/>" method="post">
		<table class="table table-bordered" style="width: 700px; margin-left: 230px;">
			<tr>
				<td colspan="2">개인정보 입력</td>
			</tr>
			<tr>
				<td style="vertical-align: middle; background-color: rgba(80, 80, 80, 0.1);">본인성명</td>
				<td>
					<div class="col-sm-7">
			...
			<tr>
				...
				<td>
					<div class="form-inline">
						...
						<div class="form-group">
							<input type="text" class="form-control" id="tel2" name="tel2" style="width: 120px"> 
							<label style="margin-left: 10px; margin-right: 10px">-</label>
						</div>
						<div class="form-group">
							<input type="text" class="form-control" id="tel3" name="tel3" style="width: 120px">
						</div>
					</div>
				</td>
			</tr>
			<tr>
				...
				<td>
					<div class="form-inline">
						<div class="form-group">
							<input type="text" class="form-control" id="id" placeholder="이메일을 입력하세요" style="margin-left: 15px" name="id">
							<label for="email">@</label>
						</div>
						<div class="form-group">
							<select class="form-control" style="margin-left: 10px" id="id" name="id2">
		...
		<div class="form-group text-center">
			<input type="submit" class="btn btn-primary btn-lg" style="margin-left: 10px" value="가입하기" />
		</div>
	</form>
	</br>
	</br>

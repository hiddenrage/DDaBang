...
<script type="text/javascript">
	...
	$(function() {		
		var currentPosition = parseInt($(".right").css("top")); 
...
<div class="content col col-xs-12 col-sm-6 col-sm-offset-3">
	<div class="row">
		...
		<div class="head col col-xs-12">
			<div class="row"><!-- row -->
				...
				<div class="left col-xs-12 col-sm-8">
					<div id="image" class="col col-xs-12"></div>
					<!-- table -->
					<div class="col-xs-12">
						<table class="table">
							<tr>
					...
					<div class="col col-xs-12" style="border: 0.5px solid gray;margin-top: 50px"></div>
					...
					<div id="scrollControl" class="col col-xs-12" style="border: 0.5px solid gray;margin-top: 50px"></div>	
				</div>				
				<!-- left -->
				<!-- right -->
				<div class="right col-xs-12 col-sm-4">
					<div id="one">
						<span class="right_head">월세</span><br/>
						<span>단기</span><br/>
						<span class="right_second">주소</span><br/>
						<span>주차가능</span>
						<hr/>
						<span class="btn btn-default col-xs-6">찜</span>
						<span class="btn btn-default col-xs-6">신고</span>
					</div>
					<div id="two">
						<hr/>
						<span class="right_head">월세</span><br/>
						<span class="right_second">대표</span><br/>
						<span class="right_second">중개 등록번호</span><br/>
						<span class="btn btn-success col-xs-12">연락처 보기</span>
					</div>
				</div>
				<!-- right -->
		...
		<!-- 해더 -->
		<!-- map -->
		<div class="col col-xs-12"><h2 style="margin-top: 50px;">위치 및 주변 편의시설</h2></div>		
		<div class="map_wrap">

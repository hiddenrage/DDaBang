     ...
     /*  $('#uploadroom').click(function(){
            ...
            <table style="margin-top: 10px; border-top: 2px solid black; margin-bottom: 30px; border-bottom: 2px solid black;">
               <tr>
                  ...
                  <td style="width: 600px;" class="form-inline">
                     ...
                     <input type="text" style="margin-top: 10px; margin-left:10px; 
                      width: 300px;" placeholder="예)금천구 가산동" class="form-control">
                      <!-- 조회하기 -->
                     <button type="button" value="button타입"
                              class="orgBtn btn btn-primary" id="lookup">조회하기</button>                        
                      <!--주소명검색 시작 -->
                  ...
                  <!-- 주소 검색시 지도 뿌려주는곳 -->
                  <td rowspan="4" style="background-color: yellow; width: 480px;">주소검색하면
                     주소띄워주는 곳</td>
               <tr>
               		<!-- 상세주소(동,호수) -->
                  <td><input style="margin-top: 10px; width: 300px; margin-left:10px;"
                     type="text" placeholder="상세주소를 입력하세요(동,호수)" id="addr2"></td>
               </tr>
               
               <tr>
                  <td><p
                        style="color: red; cursor: pointer; text-decoration: underline;  margin-left:10px;">
                        	주소가 검색되지 않으세요?</p></td>
               </tr>
            </table>
      </div>
      ...
      <div class="container-fluid">
         <table class="table table-bordered"
            ...
            <tr>
               <th style="background-color: gray;text-align: center; line-height: 30px; height: 30px;" >방 종류</th>
               <td colspan="3" style="padding-left: 10px; position: relative;" >
                  <select style="width: 150px" class="form-control"  id="roomlist" name="roomlist">
            ...
            <tr>
               <th style="background-color: gray; text-align: center; line-height: 100px; height: 100px; rowspan="1" >거래종류</th>
               <td colspan="3">
            ...
            <tr style="border-bottom: 2px solid black">
               ...
               <td>
                  <div>
                     <span style="margin-right: 10px;" >건물층수</span> 
                     <select style="width: 150px" class="form-control"  id="housefloor" name="housefloor">
                  ...
                  <hr />
                  <div>
                     <span style="margin-right: 10px;">해당층수</span> 
                     	<select style="width: 150px" class="form-control" id="selectfloor" name="selectfloor">
                     ...
                     <div class="form-group" style="padding-top: 15px">
                        <table>
                           <tr>
                              ...
                              <td><input type="text" class="form-control" id="Supplyarea" name="Supplyarea"></td>
                              <td><span>평(㎡)</span></td>
                           </tr>
                        </table>
                     </div>
      ...
      <h1>추가정보</h1>
         <div class="container-fluid">
            <div class="form-group">
            <table class="table table-bordered table_align" style="margin-bottom: 30px;">
               <tr>
                  <th rowspan="2" style="text-align: center;height: 70px; line-height: 70px; width: 100px;">관리비</th>
                  <td colspan="3">
                  <input type="checkbox" style="margin-left: 15px" id="moneyok" name="money" value="있음"
                  />&nbsp;&nbsp;있음
                  <input type="text" class="form-control" style="width: 100px; margin-left: 15px;" value="만원">&nbsp;&nbsp;만원
                  <input type="checkbox" style="margin-left: 15px" id="moneyno" name="money" value="없음"
                  />&nbsp;&nbsp;없음
                  </td>
               </tr>
               <tr>
                  <td style="font-size: 0.8em" colspan="3">
                     <span>관리비포함 항목 선택:</span>
                     <input type="checkbox" style="margin-left: 5px" id="internet" name="managemoney" value="인터넷"/>&nbsp;&nbsp;인터넷
                     <input type="checkbox" style="margin-left: 15px" id="tv" name="managemoney" value="유선TV"/>&nbsp;&nbsp;유선TV
                     <input type="checkbox" style="margin-left: 15px" id="clean" name="managemoney" value="청소비"/>&nbsp;&nbsp;청소비
                     <input type="checkbox" style="margin-left: 15px" id="water" name="managemoney" value="수도세"/>&nbsp;&nbsp;수도세
                     <input type="checkbox" style="margin-left: 15px" id="gas" name="managemoney" value="도시가스"/>&nbsp;&nbsp;도시가스
                     <input type="checkbox" style="margin-left: 15px" id="electric" name="managemoney" value="전기세"/>&nbsp;&nbsp;전기세
                  </td>
               </tr>
               <tr>
                  <th style="text-align: center;height: 10px; line-height: 10px;">주차 여부</th>
                  <td>
                     <input type="checkbox" style="margin-left: 15px" id="pakingok" name="parking" value="가능">&nbsp;&nbsp;가능
                     <input type="text" class="form-control" style="width: 100px; margin-left: 15px;">&nbsp;&nbsp;만원
                     <input type="checkbox" style="margin-left: 15px" id="parkingno" name="parking" value="불가능">&nbsp;&nbsp;불가능
                  </td>
                  <th>난방 종류</th>
                  <td>
                  <select style="width: 150px" class="form-control" id="hiter" name="hiter">
               ...
               <tr>
                  <th>엘레베이터</th>
                  <td>
                     <input type="checkbox" style="margin-left: 15px" id="elevatorok" name="elevator" value="있음">&nbsp;&nbsp;있음
                     <input type="checkbox" style="margin-left: 15px" id="elevatorno" name="elevator" value="없음">&nbsp;&nbsp;없음
                  </td>
                  <th>반려동물</th>
                  <td>
                     <input type="checkbox" style="margin-left: 15px" id="animalok" name="animal" value="가능">&nbsp;&nbsp;가능
                     <input type="checkbox" style="margin-left: 15px" id="animalno" name="animal" value="불가능">&nbsp;&nbsp;불가능
                  </td>
               </tr>
               <tr>
                  <th>입주가능일</th>
         ...
         <table class="table table-bordered table_align" style="margin-bottom: 30px;">
            <tr>
               <th>방 제목</th>
               <td>
                  <input style="width:820px" type="text" 
                  id="roomtitle" name="roomtitle" placeholder="예) 홍대역 도보5분거리, 혼자살기 좋은방 입니다.">
               </td>
            </tr>
            <tr>
            <th>상세 설명</th>
               <td>
                  <textarea rows="3" cols="120" placeholder="방에대한 추가 설명을 적어주세요 
                  	홈페이지,블로그,SNS,메신져ID,전화번호 등. 방정보에 관련된 내용 이외에는 넣을수 없습니다</br>
                  	중개수수료 언급을 할 수 없습니다.(중개수수료,공짜,무료,반값 등)
                  "></textarea>
               </td>
            </tr>
            <tr>
         ...
         <p style="border: red 1px solid; padding: 10px 10px 10px 10px">
            ...
            - 사진은 최소 3장 이상 등록해야하며, 최대 15장까지 권장합니다. 그 이상 등록할 경우 업로드 시간이 다소 지연될 수 있습니다.
         </p>
      </div>
         <textarea rows="10" cols="170"></textarea>
      
         <div style=" text-align: center;">
         <button type="button" class="btn btn-danger" style="width:200px; height: 50px;" id="cancle" name="cancle">취소</button>
         <input type="submit" class="btn btn-primary" style="width:200px; height: 50px;" id="uploadroom" name="uploadroom" value="방 올리기"/>
         </div>
   </div>
</form>
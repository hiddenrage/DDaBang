...
public class AdminMainController {
	...
	public String adminLoginProcess(@RequestParam Map map,HttpSession session) throws Exception {
		if(service.adminLogin(map)) {
			session.setAttribute("adminID", map.get("id"));
			return "redirect:/Admin/Main.bbs";
		} else
